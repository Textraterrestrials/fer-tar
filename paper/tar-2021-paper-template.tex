...
All of this is automatically produced when using BibTeX. Insert all the BibTeX entries into the file \texttt{tar2021.bib}, and then reference them via their symbolic names.
